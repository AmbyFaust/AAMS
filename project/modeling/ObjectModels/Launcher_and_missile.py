...
class LaunchSystem(Object):
    ...
    def launch_missile(self, radarId, targetId):
...
class Missile(Object):
    ObjectName = 'Rocket'
    Id = 1
    def __init__(self, launch_coordinates):  # id target and radar
        self.id = Missile.Id
        self.radarId = []
        self.targetId = []
        Missile.Id += 1
        ...
        self.trajectory = []  # Поле для хранения траектории полета до цели
